        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="padding-bottom:24px;">
              ...
              <div style="font-size:11px;color:#A8A29E;text-transform:uppercase;letter-spacing:0.18em;margin-top:2px;">
          ...
          <!-- Card principale -->
          <tr>
            <td style="background:#ffffff;border:1px solid #E7E5E4;border-radius:16px;padding:32px;">
              ${body}
              ${ctaUrl ? `
              <div style="margin-top:24px;">
                <a href="${escapeAttr(ctaUrl)}" style="display:inline-block;background:#BA7517;color:#ffffff;text-decoration:none;padding:12px 22px;border-radius:8px;font-weight:500;font-size:15px;">
          ...
          <!-- Footer -->
          <tr>
            <td style="padding:24px 8px;font-size:11px;color:#A8A29E;line-height:1.5;">
              Pro Loco Soresina &middot; Comune di Soresina (CR)<br>
              Hai ricevuto questa email perché hai un account su <a href="${SITE_URL}" style="color:#BA7517;text-decoration:none;">mercati-soresina</a>.<br>
              <a href="${SITE_URL}/privacy" style="color:#A8A29E;text-decoration:underline;">Privacy</a> &middot;
              <a href="${SITE_URL}/cookie" style="color:#A8A29E;text-decoration:underline;">Cookie</a> &middot;
              <a href="${SITE_URL}/termini" style="color:#A8A29E;text-decoration:underline;">Termini</a>
            </td>
          </tr>
        </table>
      </td>
